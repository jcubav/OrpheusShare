...
public class mPlayer {
    ...
    private Bitstream bitstream; //The MPEG audi bitstream.
	 ...
	 */
	public mPlayer(InputStream stream) throws JavaLayerException
	{
		this(stream, null);
	}

	public mPlayer(InputStream stream, AudioDevice device) throws JavaLayerException
	{
